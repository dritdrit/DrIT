...
def main(args):
	...
	work_dir = os.path.join(args.log_dir, args.domain_name+'_'+args.task_name, args.algorithm, '1-2'+str(args.seed)+'_'+args.eval_mode_1+'_'+args.eval_mode_2+args.if_base)
