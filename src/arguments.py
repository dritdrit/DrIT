...
def parse_args():
	...
	parser.add_argument('--if_base', default='drit', type=str)
	parser.add_argument('--if_DrE', default=True, type=str)
	
	# agent
	parser.add_argument('--algorithm', default='drit', type=str)
	...
	# encoder-----------------------------------------------------
	parser.add_argument('--encoder_lr', default=0.00005, type=float)
	parser.add_argument('--encoder_beta', default=0.9, type=float)
	parser.add_argument('--encoder_multi', default=0, type=float)
	# ------------------------------------------------------------
	...
	# eval
	parser.add_argument('--save_freq', default='1000k', type=str)    #----------------
	...
	assert args.algorithm in {'sac', 'rad', 'curl', 'pad', 'soda', 'drq', 'svea', 'sgqn', 'drit'}, f'specified algorithm "{args.algorithm}" is not supported'
